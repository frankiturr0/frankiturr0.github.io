...
senado_nomina$voto_al_dnu <- factor(as.character(senado_nomina$voto_al_dnu), levels=c("En contra", "Posible en contra", "En negociación", "Indefinido", "Posible a favor", "A favor"), labels = c("En contra", "Posible en contra", "En negociación", "Indefinido", "Posible a favor", "A favor"))
...
df_filtrado <- senado_nomina %>%
  filter(voto_al_dnu %in% c("En contra", "Posible en contra", "En negociación", "Indefinido", "Posible en contra", "A favor"))
